...
//            AlbumId = mView.findViewById(R.id.aid);
//            Id = mView.findViewById(R.id.id);
//            Url = mView.findViewById(R.id.url);
//            ThumbnailUrl = mView.findViewById(R.id.turl);
...
//        holder.AlbumId.setText(dataList.get(position).getAlbumId());
//        holder.Id.setText(dataList.get(position).getId().toString());
//        holder.Url.setText(dataList.get(position).getUrl());
//        holder.ThumbnailUrl.setText(dataList.get(position).getThumbnailUrl());
